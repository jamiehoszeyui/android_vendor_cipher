...
echo ' "url":' "\"https://master.dl.sourceforge.net/project/CipherOS/SHADE/"$CODENAME"/$(basename $(ls "$DIR"/out/target/product/"$CODENAME"/CipherOS*.zip))\","
echo ' "version":' "\"2.1-SHADE\""
echo "}"
echo "]"
echo "}"
